...
let first = ['Иногда один день, проведённый в других местах, даёт больше, чем десять лет проведённых дома','Анатоль Франс']
let overVoice = ['Вы вообще кто такой?']
first.unshift('\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n')
let chat = [first]
...
export default function App ({ navigation }) {
  ...
  async function plot(e){
    ...
    if ( e == 'Вы ошиблись номером' ) {
      ...
      showFinalButtons(
        ['Питер не успел положить телефон, как вдруг, пуля 9 калибра попала ему в голову и прошла на  вылет'],
        ['На шаг назад', 'Начать новую игру\n(поражение)']
      )
    ...
    if(e == 'Начать новую игру\n(поражение)' || e == 'Начать новую игру\n(открыта концовка)' || e == 'Начать новую игру'){
